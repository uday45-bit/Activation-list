...
def render_division_summary_html(div_summary, period_str):
    ...
    <div style="font-family:Arial, Helvetica, sans-serif;">
        <div style="font-size:18px; font-weight:700; margin-bottom:10px;">SBI POS Machine Activation Status (Period: {period_str})</div>
...
def build_excel_report(merged, div_summary, unmapped, period_str):
    ...
    with pd.ExcelWriter(output, engine="xlsxwriter") as writer:
        ...
        ws.merge_range(0, 0, 0, 4, f"SBI POS Machine Activation Status (Period: {period_str})", title_fmt)
